...
class interact_m4image_exchange extends StatefulWidget {
  const interact_m4image_exchange({Key? key,
  ...
  @override
  _interact_m4image_exchange createState() => _interact_m4image_exchange();
}


class _interact_m4image_exchange extends State<interact_m4image_exchange> {
  ...
  AlertDialog alert1 = const AlertDialog(
    title: Text("Work"),
    content: Text('You can add value to the project by thinking about costs, and possibly cost cutting, '
        'and certainly by working to the budget.'),
    actions: [
      //okButton,
    ],
  );
  AlertDialog alert2 = const AlertDialog(
    title: Text("Pay"),
    content: Text("Your work helps meet the brief. In return, you receive pay."),
    actions: [
      //okButton,
    ],
  );
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: [
                  Container(
                    child: Center(
                      child: Image.asset('assets/Module_4_Exchange.PNG',
                          //height: 400,
