...
class learn_expandM1_push extends StatefulWidget {
  learn_expandM1_push({
    Key? key,
  ...
  @override
  State createState() {
    return _learn_expandM1_push();
  }
}

class _learn_expandM1_push extends State<learn_expandM1_push> {
  bool ticked = false;
  ...
  Widget build(BuildContext context) {
    ...
    buildList() {
      return Column(
        children: <Widget>[
          for (var i in [
            "When you tell people what you want them to do, explain why and how, "
                "without inviting much comment or reaction. "
  ...
  Widget build(BuildContext context) {
    ...
    buildList() {
      return Column(
        children: <Widget>[
          for (var i in [
            "When you use questions to help people understand for themselves why and "
                "how they should do what you want them to do. "
                "\nThe key behaviours are: "
                "\nSeeking information. "
                "\nSeeking proposals. "
                "\nBuilding."
