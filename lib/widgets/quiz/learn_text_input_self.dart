...
class learn_text_input_self extends StatefulWidget {
  const learn_text_input_self({
    Key? key,
  ...
  @override
  State<learn_text_input_self> createState() => _learn_text_input_self();
}

class _learn_text_input_self extends State<learn_text_input_self> {
