...
class learn_text_input2 extends StatefulWidget {
  const learn_text_input2({
    Key? key,
  ...
  @override
  State<learn_text_input2> createState() => _learn_text_input2();
}

class _learn_text_input2 extends State<learn_text_input2> {
