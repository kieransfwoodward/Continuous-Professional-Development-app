...
class learn_expandM1_peakRapport extends StatefulWidget {
  learn_expandM1_peakRapport({
    Key? key,
  ...
  @override
  State createState() {
    return _learn_expandM1_peakRapport();
  }
}

class _learn_expandM1_peakRapport extends State<learn_expandM1_peakRapport> {
  bool ticked = false;
