...
class interact_m4image_use extends StatefulWidget {
  const interact_m4image_use({Key? key,
  ...
  @override
  _interact_m4image_use createState() => _interact_m4image_use();
}


class _interact_m4image_use extends State<interact_m4image_use> {
  ...
  AlertDialog alert1 = const AlertDialog(
    title: Text("Skills and Knowledge"),
    content: Text('You bring in valuable skills and knowledge to the workplace every day.'),
    actions: [
      //okButton,
    ],
  );
  AlertDialog alert2 = const AlertDialog(
    title: Text("Teamwork"),
    content: Text("By working as a team, collectively you can achieve more than any one "
  ...
  AlertDialog alert3 = const AlertDialog(
    ...
    content: Text('You can motivate others, if they are not having the best day.'),
    actions: [
      //okButton,
    ],
  );
  AlertDialog alert4 = const AlertDialog(
    title: Text("Positive Behaviours"),
    content: Text("Positive behaviours make all the difference in you and your peers wanting to "
        "come to work, rather than having to come to work."),
    actions: [
      //okButton,
    ],
  );
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: [
                  Container(
                    child: Center(
                      child: Image.asset('assets/Module_4_Use.PNG',
                          //height: 400,
              ...
              Row(
                ...
                children: [
                  ElevatedButton(
                    ...
                    child: Text('Skills and Knowledge'),
                  ),
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(primary: buildMaterialColor(HexColor("#d47828"))),
                    onPressed: () {
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: Text('Positive Behaviours'),
                  ),
                ],
              ),
